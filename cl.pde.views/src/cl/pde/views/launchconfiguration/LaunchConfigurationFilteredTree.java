...
/**
 * The class <b>LaunchConfigurationFilteredTree</b> allows to.<br>
 */
class LaunchConfigurationFilteredTree extends FilteredTree
{
   ...
   * @param filter
   */
  LaunchConfigurationFilteredTree(Composite parent, NotTreeParentPatternFilter filter)
  {
  ...
  {
    TreeViewer launchConfigurationViewer = super.doCreateTreeViewer(parent, style);
    ...
    setBackground(launchConfigurationViewer.getTree().getBackground());
    ...
    launchConfigurationViewer.addFilter(featureViewerFilter);
