...
Un double clic sur une feature ou un bundle ouvre l'éditeur de la feature/bundle automatiquement.
...
* Expand node : Déplie l'arborescence de chaque noeud sélectionné
* Collapse node : Replie l'arborescence de chaque noeud sélectionné
* Open Jar : Ouvre le jar avec l'application associée
